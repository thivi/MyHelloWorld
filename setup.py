...
setup(
  ...
  url = 'https://github.com/sathiyakugan/reponame',   # Provide either the link to your github or to your website
  download_url = 'https://github.com/sathiyakugan/reponame/archive/v_01.tar.gz',    # I explain this later on
